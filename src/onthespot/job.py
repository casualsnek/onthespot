...
from otslib.core.mediaitem import SpotifyTrackMedia, SpotifyEpisodeMedia, SpotifyAlbum, SpotifyPodcast, SpotifyPlaylist, SpotifyArtist
...
class MediaDownloadJob:
    def __init__(self, media_uuid: str, media_type: SpotifyTrackMedia|SpotifyEpisodeMedia,
        ...
        self.__media_type: SpotifyTrackMedia|SpotifyEpisodeMedia = media_type
